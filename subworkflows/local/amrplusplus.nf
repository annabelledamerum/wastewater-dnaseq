...
workflow AMRPLUSPLUS {
    ...
    amr_annotation_additional = Channel.fromPath("s3://zymo-filesystem/home/nsharp/amrplusplus_ref/megares_v3.00_annotations_additional.csv", checkIfExists:true)
    ...
    ch_output_file_paths = ch_output_file_paths.mix( 
        RESISTOME_RESULTS.out.class_count_matrix, 
