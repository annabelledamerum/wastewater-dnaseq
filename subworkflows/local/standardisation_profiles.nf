...
include { METAPHLAN4_MERGEMETAPHLANTABLES                                       } from '../../modules/nf-core/metaphlan4/mergemetaphlantables/main'
...
workflow STANDARDISATION_PROFILES {
    ...
    ch_input_for_taxpasta = profiles
                            .map {
                                    meta, profile ->
                                        ...
                                        meta_new.tool = meta.tool == 'metaphlan4' ? 'metaphlan' : meta.tool == 'malt' ? 'megan6' : meta.tool
                                        [meta_new, profile]
                            }
                            .groupTuple ()
    ...
    */
    ch_input_profiles = profiles
        .branch {
            ...
            metaphlan4: it[0]['tool'] == 'metaphlan4'
    ...
    */
    ...
    ch_profiles_for_metaphlan4 = ch_input_profiles.metaphlan4
                            .map { [it[0]['db_name'], it[1]] }
                            .groupTuple()
                            .map {
                                [[id:it[0]], it[1]]
    ...
    METAPHLAN4_MERGEMETAPHLANTABLES ( ch_profiles_for_metaphlan4 )
    ch_multiqc_files = ch_multiqc_files.mix( METAPHLAN4_MERGEMETAPHLANTABLES.out.txt )
    ch_versions = ch_versions.mix( METAPHLAN4_MERGEMETAPHLANTABLES.out.versions )
